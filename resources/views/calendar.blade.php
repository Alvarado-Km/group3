<x-layout>
    <x-artisannav2></x-artisannav2>
        ...
        <div class="bg-orange-400 w-full sm:w-40 h-40 rounded-full absolute top-1 opacity-20 max-sm:right-0 sm:left-56 z-0"></div>
        <div class="bg-red-500 w-full sm:w-40 h-24 absolute top-0 -left-0 opacity-20 z-0"></div>
        <div class="bg-yellow-600 w-full sm:w-40 h-24 absolute top-40 -left-0 opacity-20 z-0"></div>
          ...
          <div class="w-full max-w-7xl mx-auto px-2 lg:px-8">
            <div class="grid grid-cols-12 gap-8 max-w-4xl mx-auto xl:max-w-full">
              <div class="col-span-12 xl:col-span-5">
                <h2 class="font-manrope text-3xl leading-tight text-gray-900 mb-1.5"> Próximos eventos</h2>
                <p class="text-lg font-normal text-gray-600 mb-8">Revisa la agenda</p>
                <div class="flex gap-5 flex-col">
                  <div class="p-6 rounded-xl bg-white">
                    ...
                    <h6 class="text-xl leading-8 font-semibold text-black mb-1">Taller de artesanía en cuero</h6>
                    <p class="text-base font-normal text-gray-600">Aprende como trabajar y elaborar productos artesanales con cuero.</p>
                  </div>
                  <div class="p-6 rounded-xl bg-white">
                    <div class="flex items-center justify-between mb-3">
                      <div class="flex items-center gap-2.5">
                    ...
                    <h6 class="text-xl leading-8 font-semibold text-black mb-1">Curso de tejido</h6>
                    <p class="text-base font-normal text-gray-600">Aprende a elaborar tus propios tejidos de una forma creativa</p>
                  </div>
                  <div class="p-6 rounded-xl bg-white">
                    <div class="flex items-center justify-between mb-3">
                      <div class="flex items-center gap-2.5">
                    ...
                    <h6 class="text-xl leading-8 font-semibold text-black mb-1">Taller de Alfarería</h6>
                    <p class="text-base font-normal text-gray-600">En este taller aprenderás a elaborar objetos de barro, fácil, rápido y barato</p>
                  </div>
                </div>
              </div>
                ...
                <div class="border border-indigo-200 rounded-xl">
                  ...
                  <div class="grid grid-cols-7 rounded-b-xl">
                    ...
                    <div class="flex xl:aspect-square max-xl:min-h-[60px] p-3.5 relative bg-white border-r border-b border-indigo-200 transition-all duration-300 hover:bg-indigo-50 cursor-pointer">
                      ...
                      <div class="absolute top-9 bottom-1 left-3.5 p-1.5 xl:px-2.5 h-max rounded bg-yellow-50 ">
                        <p class="hidden xl:block text-xs font-medium text-red-600 mb-px">Meet & Greet con artesanos nacionales</p>
                        <span class="hidden xl:block text-xs font-normal text-red-600 whitespace-nowrap">10:00 - 11:00</span>
                        <p class="xl:hidden w-2 h-2 rounded-full bg-purple-600"></p>
                      </div>
                    </div>
                    <div class="flex xl:aspect-square max-xl:min-h-[60px] p-3.5 bg-white border-r border-b border-red-200 transition-all duration-300 hover:bg-indigo-50 cursor-pointer">
                    ...
                    <div class="flex xl:aspect-square max-xl:min-h-[60px] p-3.5 bg-white relative border-r border-b border-indigo-200 transition-all duration-300 hover:bg-indigo-50 cursor-pointer">
                      ...
                      <div class="absolute top-9 bottom-1 left-3.5 p-1.5 xl:px-2.5 h-max rounded bg-red-50 ">
                        <p class="hidden xl:block text-xs font-medium text-emerald-600 mb-px whitespace-nowrap">Taller del añil </p>
                    ...
                    <div class="flex xl:aspect-square max-xl:min-h-[60px] p-3.5 relative bg-white border-r border-b border-indigo-200 transition-all duration-300 hover:bg-indigo-50 cursor-pointer">
                      ...
                      <div class="absolute top-9 bottom-1 left-3.5 p-1.5 xl:px-2.5 h-max rounded bg-red-50 ">
                        <p class="hidden xl:block text-xs font-medium text-sky-600 mb-px whitespace-nowrap">Taller de textiles</p>
                    ...
                    <div class="flex xl:aspect-square max-xl:min-h-[60px] p-3.5 relative bg-gray-50 border-r border-indigo-200 transition-all duration-300 hover:bg-indigo-50 cursor-pointer">
                      ...
                      <div class="absolute top-9 bottom-1 left-3.5 p-1.5 xl:px-2.5 h-max rounded bg-yellow-50 ">
                        <p class="hidden xl:block text-xs font-medium text-purple-600 mb-px whitespace-nowrap">Taller de alfareria II</p>
