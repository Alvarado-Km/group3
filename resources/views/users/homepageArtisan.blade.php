<x-layout>
    ...
    <h1 class="text-center font-common text-bold text-6xl mt-16 mb-4"> ¿Por qué Artesía? </h1>

    <p class="text-xl mb-16 mx-48 text-justify font-common mt-8">¿Por qué deberías usar artesía?
    ...
    <h2 class="text-center font-common text-bold text-6xl mt-16 mb-4">¿Cómo tomar mejores fotos para tus productos?
    </h2>
    <div class="columns-6   mt-24 ml-16 mb-16">
        ...
        <p class="col-start-2  text-justify font-common mr-6"> Deja un margen en cada imagen y centra el producto.
        </p> </img>
    ...
    <div class="columns-6   mt-36 ml-16 mb-16">
        ...
        <p class="col-start-2  text-justify font-common mr-6">
            ...
            características especiales, haz tomas cercanas para mostrarlos. </p> </img>
