<x-layout>
    <div class="h-screen w-screen bg-cover bg-center" style="background-image: url({{ asset('/img/wbg.png') }}">

    <x-primarynav />

    <div>
        <h1 class="text-2xl font-title flex justify-center mt-20 ">"Tradition in every piece"</h1>
    </div>

    <main class="mt-10 flex flex-col items-center justify-center text-center px-10 font-common text-bold">
        <p class="text-lg mb-8 max-w-2xl backdrop-blur bg-white/20 px-8 py-3">
        ...
        <p class="mt-4 text-gray-800">Eleva tu vida con tesoros artesanales</p>
    </main>
